...
Graphik::IndexedModel OBJModel::ToIndexedModel()
{
    Graphik::IndexedModel result;
    Graphik::IndexedModel normalModel;
...
unsigned int OBJModel::FindLastVertexIndex(const std::vector<OBJIndex*>& indexLookup, const OBJIndex* currentIndex, const Graphik::IndexedModel& result)
{
